    ...
    try {
      ...
      if (res.ok) {
        ...
        if (eraOnboarding) {
          ...
          // 🔴 VOLTOU a ser o Mapa em 2026-09-19 (a pedido). Ele já tinha sido o destino
          // até 2026-09-05, quando virou Painel Principal porque o Mapa havia saído do
          // menu — hoje é o PAINEL que está escondido e o Mapa é que está lá, então a
          // razão daquela troca se inverteu. Como a confirmação do cadastro é exigida UMA
          // vez por empresa (§36-h), este é o primeiro destino de quem acaba de entrar —
          // e tem de ser o MESMO destino do login (`Login.tsx`).
