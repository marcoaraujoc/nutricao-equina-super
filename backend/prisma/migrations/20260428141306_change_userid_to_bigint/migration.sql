/*
  ...
  - You are about to alter the column `userId` on the `tb_animais` table. The data in that column could be lost. The data in that column will be cast from `Int` to `BigInt`.
  - You are about to alter the column `userId` on the `tb_audit_logs` table. The data in that column could be lost. The data in that column will be cast from `Int` to `BigInt`.
  - You are about to alter the column `criadopor` on the `tb_dieta` table. The data in that column could be lost. The data in that column will be cast from `Int` to `BigInt`.
  - You are about to alter the column `modificadopor` on the `tb_dieta` table. The data in that column could be lost. The data in that column will be cast from `Int` to `BigInt`.
