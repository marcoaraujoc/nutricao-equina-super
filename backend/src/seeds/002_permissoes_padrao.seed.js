...
const PERMISSOES_PADRAO = {
  ...
  GESTOR: {
    ...
    'cadastro.prestador.editar':   'FULL',
    'cadastro.prestador.deletar':  'FULL',
    'cadastro.prestador.ativar':   'FULL',
    ...
    'documentos.templates.ler':         'FULL',
    'documentos.templates.criar':       'PROPRIO',
    'documentos.templates.editar':      'PROPRIO',
    'documentos.templates.deletar':     'FULL',
    'documentos.emitidos.ler':          'FULL',
    'documentos.emitidos.criar':        'PROPRIO',
    'documentos.emitidos.imprimir':     'FULL',
    'documentos.emitidos.compartilhar': 'PROPRIO',
  ...
  VETERINARIO: {
    ...
    'cadastro.prestador.editar':   'PROPRIO',
    'cadastro.prestador.deletar':  'NENHUM',
    'cadastro.prestador.ativar':   'PROPRIO',
    ...
    'documentos.templates.ler':         'EQUIPE',
    'documentos.templates.criar':       'PROPRIO',
    'documentos.templates.editar':      'PROPRIO',
    'documentos.templates.deletar':     'NENHUM',
    'documentos.emitidos.ler':          'EQUIPE',
    'documentos.emitidos.criar':        'PROPRIO',
    'documentos.emitidos.imprimir':     'EQUIPE',
    'documentos.emitidos.compartilhar': 'PROPRIO',
  ...
  PROPRIETARIO: {
    ...
    'cadastro.prestador.editar':   'NENHUM',
    'cadastro.prestador.deletar':  'NENHUM',
    'cadastro.prestador.ativar':   'NENHUM',
  ...
  FORNECEDOR: {
    ...
    'documentos.templates.ler':         'NENHUM',
    'documentos.templates.criar':       'NENHUM',
    'documentos.templates.editar':      'NENHUM',
    'documentos.templates.deletar':     'NENHUM',
    'documentos.emitidos.ler':          'NENHUM',
    'documentos.emitidos.criar':        'NENHUM',
    'documentos.emitidos.imprimir':     'NENHUM',
    'documentos.emitidos.compartilhar': 'NENHUM',
...
const MODULOS_SISTEMA = [
  ...
  // ── Cadastro — Prestador ─────────────────────────────────────────────────────
  // Catálogo PRÓPRIO e independente de Fornecedor — mesma forma de cadastro,
  // tabela e RLS próprios (tb_prestadores). Ver CLAUDE.md §5.
  { slug: 'cadastro.prestador.ler',     modulo: 'cadastro', submodulo: 'prestador', acao: 'ler',     label: 'Prestadores — Visualizar',      ordemExib: 16.6 },
  { slug: 'cadastro.prestador.criar',   modulo: 'cadastro', submodulo: 'prestador', acao: 'criar',   label: 'Prestadores — Cadastrar',       ordemExib: 16.61 },
  { slug: 'cadastro.prestador.editar',  modulo: 'cadastro', submodulo: 'prestador', acao: 'editar',  label: 'Prestadores — Editar',          ordemExib: 16.62 },
  { slug: 'cadastro.prestador.deletar', modulo: 'cadastro', submodulo: 'prestador', acao: 'deletar', label: 'Prestadores — Excluir',         ordemExib: 16.63 },
  { slug: 'cadastro.prestador.ativar',  modulo: 'cadastro', submodulo: 'prestador', acao: 'ativar',  label: 'Prestadores — Ativar/Inativar', ordemExib: 16.64 },
  ...
  // TEMPLATE (o modelo reutilizável) e DOCUMENTO (a emissão) têm slugs separados de
  // propósito: quem emite atestado no campo não precisa poder reescrever o modelo da
  // clínica — e quem desenha o modelo não necessariamente emite.
  { slug: 'documentos.templates.ler',      modulo: 'documentos', submodulo: 'templates', acao: 'ler',      label: 'Documentos Modelos — Visualizar', ordemExib: 84.8 },
  { slug: 'documentos.templates.criar',    modulo: 'documentos', submodulo: 'templates', acao: 'criar',    label: 'Documentos Modelos — Criar',      ordemExib: 84.81 },
  { slug: 'documentos.templates.editar',   modulo: 'documentos', submodulo: 'templates', acao: 'editar',   label: 'Documentos Modelos — Editar',     ordemExib: 84.82 },
  { slug: 'documentos.templates.deletar',  modulo: 'documentos', submodulo: 'templates', acao: 'deletar',  label: 'Documentos Modelos — Excluir',    ordemExib: 84.83 },
  { slug: 'documentos.emitidos.ler',       modulo: 'documentos', submodulo: 'emitidos',  acao: 'ler',      label: 'Documentos — Histórico',          ordemExib: 84.84 },
  { slug: 'documentos.emitidos.criar',     modulo: 'documentos', submodulo: 'emitidos',  acao: 'criar',    label: 'Documentos — Emitir',             ordemExib: 84.85 },
  { slug: 'documentos.emitidos.imprimir',  modulo: 'documentos', submodulo: 'emitidos',  acao: 'imprimir', label: 'Documentos — Imprimir/PDF',       ordemExib: 84.86 },
  { slug: 'documentos.emitidos.compartilhar', modulo: 'documentos', submodulo: 'emitidos', acao: 'compartilhar', label: 'Documentos — Compartilhar',  ordemExib: 84.87 },
