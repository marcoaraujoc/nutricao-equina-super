...
const { escopoEvolucaoWhere, semEscopoClinico } = require('../lib/clinicalScope');
    ...
    try {
      ...
      const animalNoEscopo = {
        AND: [
          escopoAnimal,
          { ativo: true },
          ...(req.empresaId ? [{ empresaId: Number(req.empresaId) }] : []),
        ],
      };
      ...
      const escopoAgenda = semEscopoClinico(req)
        ? {}
        : req.empresaId
